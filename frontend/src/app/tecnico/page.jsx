...
import { AlertCircle, Loader2, Clock, CheckCircle, AlertTriangle, XCircle } from 'lucide-react';
...
function TecnicoDashboard() {
  ...
  // Filtrar chamados abertos e em atendimento
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Painel de Atendimento</h1>
          <p className="text-slate-400 mt-2">Chamados aguardando sua atenção</p>
        </div>
        ...
        {isLoading || loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Nenhum chamado pendente</h3>
            <p className="text-slate-400">Todos os chamados foram resolvidos! Bom trabalho! 🎉</p>
          </div>
        ) : (
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start gap-3 mb-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-slate-400 mt-1">
                              Solicitante: <span className="text-slate-300">{chamado.cliente_nome}</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 text-xs text-slate-500">
                          ...
                          <span>•</span>
                          <span>Equipamento: {chamado.equipamento_nome}</span>
                          <span>•</span>
